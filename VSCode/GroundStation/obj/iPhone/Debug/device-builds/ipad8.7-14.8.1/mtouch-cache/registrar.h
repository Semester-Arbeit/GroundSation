...
@class SceneDelegate;
@class AppDelegate;
@class GroundStation_PreflightView;
@class GroundStation_CheckBox;
@class GroundStation_Checklist;
@class GroundStation_UIconsole;
@class GroundStation_ParameterConfig;
@class GroundStation_HistoryPlot;
...
@class GroundStation_InflightView;
...
@interface GroundStation_PreflightView : UIView {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
...
@interface GroundStation_CheckBox : UIView {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
...
@interface GroundStation_Checklist : UIView {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
...
@interface GroundStation_UIconsole : UIView {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
...
@interface GroundStation_ParameterConfig : UIView {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
...
@interface GroundStation_HistoryPlot : UIView {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
...
@interface GroundStation_ValuePlot : UIView {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
...
@interface GroundStation_UIStatusDisplay : UIView {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
...
@interface GroundStation_UIDataSnapshot : UILabel {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
...
@interface GroundStation_UIMulitView : UIView {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
...
@interface GroundStation_StandByView : UIView {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
...
@interface GroundStation_InflightView : UIView {
}
	-(void) release;
	-(id) retain;
	-(uint32_t) xamarinGetGCHandle;
