...
@implementation SceneDelegate {
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, 0x3C304);
	}
...
@implementation UIKit_UIControlEventProxy {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, 0x29204);
	}
...
@implementation Foundation_NSDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, 0x39F04);
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_5 (self, _cmd, &managed_method, &call_super, 0x39E04);
		if (call_super && rv) {
...
@implementation __MonoMac_NSSynchronizationContextDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, 0x3A204);
	}
@end
...
@implementation Foundation_NSAsyncDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, 0x3A404);
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_5 (self, _cmd, &managed_method, &call_super, 0x3A304);
		if (call_super && rv) {
...
@implementation __MonoMac_NSAsyncActionDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, 0x3A604);
	}
@end
...
@implementation __MonoMac_NSAsyncSynchronizationContextDispatcher {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, 0x3A804);
	}
@end
...
@implementation GLKit_GLKView__GLKViewDelegate {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, p1, 0x1C304);
	}
...
@implementation __NSObject_Disposer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_11 (self, _cmd, &managed_method, p0, 0x3ED04);
	}
	...
	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		bool call_super = false;
		id rv = native_to_managed_trampoline_5 (self, _cmd, &managed_method, &call_super, 0x3EB04);
		if (call_super && rv) {
			struct objc_super super = {  rv, [NSObject class] };
			rv = ((id (*)(objc_super*, SEL)) objc_msgSendSuper) (&super, @selector (init));
		}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{ NULL, 0x7504 /* #4 'UIView' => 'UIKit.UIView, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x700 /* #5 'GroundStation_StandByView' => 'GroundStation.StandByView, GroundStation' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x800 /* #6 'GroundStation_InflightView' => 'GroundStation.InflightView, GroundStation' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x900 /* #7 'GroundStation_PreflightView' => 'GroundStation.PreflightView, GroundStation' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xA00 /* #8 'GroundStation_CheckBox' => 'GroundStation.CheckBox, GroundStation' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xB00 /* #9 'GroundStation_Checklist' => 'GroundStation.Checklist, GroundStation' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xC00 /* #10 'GroundStation_UIconsole' => 'GroundStation.UIconsole, GroundStation' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xE00 /* #11 'GroundStation_ParameterConfig' => 'GroundStation.ParameterConfig, GroundStation' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xF00 /* #12 'GroundStation_HistoryPlot' => 'GroundStation.HistoryPlot, GroundStation' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x1000 /* #13 'GroundStation_ValuePlot' => 'GroundStation.ValuePlot, GroundStation' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x1200 /* #14 'GroundStation_UIStatusDisplay' => 'GroundStation.UIStatusDisplay, GroundStation' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x7604 /* #15 'UIViewController' => 'UIKit.UIViewController, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		...
		{ NULL, 0x4A04 /* #18 'EAGLContext' => 'OpenGLES.EAGLContext, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x5504 /* #19 'CIColor' => 'CoreImage.CIColor, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x5704 /* #20 'CIContext' => 'CoreImage.CIContext, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x5804 /* #21 'CIImage' => 'CoreImage.CIImage, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x6604 /* #22 'CALayer' => 'CoreAnimation.CALayer, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x6704 /* #23 'CALayerDelegate' => 'CoreAnimation.CALayerDelegate, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x6804 /* #24 'CAEAGLLayer' => 'CoreAnimation.CAEAGLLayer, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x6A04 /* #25 'UIApplication' => 'UIKit.UIApplication, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x6E04 /* #26 'UIControl' => 'UIKit.UIControl, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x6B04 /* #27 'UIButton' => 'UIKit.UIButton, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x6C04 /* #28 'UIColor' => 'UIKit.UIColor, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x6D04 /* #29 'UIKit_UIControlEventProxy' => 'UIKit.UIControlEventProxy, Xamarin.iOS' */, (MTTypeFlags) (2) /* UserType */ },
		{ NULL, 0x7004 /* #30 'UIImage' => 'UIKit.UIImage, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x7204 /* #31 'UISegmentedControl' => 'UIKit.UISegmentedControl, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x7304 /* #32 'UITextField' => 'UIKit.UITextField, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x8904 /* #33 'UIScrollView' => 'UIKit.UIScrollView, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x7404 /* #34 'UITextView' => 'UIKit.UITextView, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x7704 /* #35 'UIWindow' => 'UIKit.UIWindow, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x8104 /* #36 'UILabel' => 'UIKit.UILabel, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x8304 /* #37 'UIScene' => 'UIKit.UIScene, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x8404 /* #38 'UISceneConfiguration' => 'UIKit.UISceneConfiguration, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x8504 /* #39 'UISceneConnectionOptions' => 'UIKit.UISceneConnectionOptions, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x8804 /* #40 'UISceneSession' => 'UIKit.UISceneSession, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x8A04 /* #41 'UISlider' => 'UIKit.UISlider, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x8B04 /* #42 'UISwitch' => 'UIKit.UISwitch, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x9204 /* #43 'NSArray' => 'Foundation.NSArray, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x9C04 /* #44 'NSNull' => 'Foundation.NSNull, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x9D04 /* #45 'NSRunLoop' => 'Foundation.NSRunLoop, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x9E04 /* #46 'NSSet' => 'Foundation.NSSet, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0xA104 /* #47 'NSString' => 'Foundation.NSString, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0xA604 /* #48 'Foundation_NSDispatcher' => 'Foundation.NSDispatcher, Xamarin.iOS' */, (MTTypeFlags) (2) /* UserType */ },
		{ NULL, 0xA704 /* #49 '__MonoMac_NSSynchronizationContextDispatcher' => 'Foundation.NSSynchronizationContextDispatcher, Xamarin.iOS' */, (MTTypeFlags) (2) /* UserType */ },
		{ NULL, 0xA804 /* #50 'Foundation_NSAsyncDispatcher' => 'Foundation.NSAsyncDispatcher, Xamarin.iOS' */, (MTTypeFlags) (2) /* UserType */ },
		{ NULL, 0xA904 /* #51 '__MonoMac_NSAsyncActionDispatcher' => 'Foundation.NSAsyncActionDispatcher, Xamarin.iOS' */, (MTTypeFlags) (2) /* UserType */ },
		{ NULL, 0xAA04 /* #52 '__MonoMac_NSAsyncSynchronizationContextDispatcher' => 'Foundation.NSAsyncSynchronizationContextDispatcher, Xamarin.iOS' */, (MTTypeFlags) (2) /* UserType */ },
		{ NULL, 0xAB04 /* #53 'NSAutoreleasePool' => 'Foundation.NSAutoreleasePool, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0xB604 /* #54 'NSEnumerator' => 'Foundation.NSEnumerator, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0xB704 /* #55 'NSException' => 'Foundation.NSException, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x5104 /* #56 'GLKit_GLKView__GLKViewDelegate' => 'GLKit.GLKView+_GLKViewDelegate, Xamarin.iOS' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x5004 /* #57 'GLKView' => 'GLKit.GLKView, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x9304 /* #58 'NSData' => 'Foundation.NSData, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x9504 /* #59 'NSDictionary' => 'Foundation.NSDictionary, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x9A04 /* #60 'NSMutableData' => 'Foundation.NSMutableData, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0xAF04 /* #61 '__NSObject_Disposer' => 'Foundation.NSObject+NSObject_Disposer, Xamarin.iOS' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x512 /* #62 'SKCanvasView' => 'SkiaSharp.Views.iOS.SKCanvasView, SkiaSharp.Views.iOS' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x210 /* #63 'ChartView' => 'Microcharts.iOS.ChartView, Microcharts.iOS' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x612 /* #64 'SkiaSharp_Views_iOS_SKGLLayer' => 'SkiaSharp.Views.iOS.SKGLLayer, SkiaSharp.Views.iOS' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x712 /* #65 'SKGLView' => 'SkiaSharp.Views.iOS.SKGLView, SkiaSharp.Views.iOS' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xB12 /* #66 'SkiaSharp_Views_iOS_SKCanvasLayer' => 'SkiaSharp.Views.iOS.SKCanvasLayer, SkiaSharp.Views.iOS' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0 },
	};

	static const MTManagedClassMap __xamarin_skipped_map [] = {
		{ 0xA004, 0x9E04 /* 'Foundation.NSSet`1' => 'Foundation.NSSet' */ },
	};
	...
	static const MTProtocolWrapperMap __xamarin_protocol_wrapper_map [] = {
		...
		{ 0x7804 /* UIKit.IUIApplicationDelegate */, 0x7904 /* UIApplicationDelegateWrapper */ },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [6].handle = [GroundStation_InflightView class];
	__xamarin_class_map [7].handle = [GroundStation_PreflightView class];
	__xamarin_class_map [8].handle = [GroundStation_CheckBox class];
	__xamarin_class_map [9].handle = [GroundStation_Checklist class];
	__xamarin_class_map [10].handle = [GroundStation_UIconsole class];
	__xamarin_class_map [11].handle = [GroundStation_ParameterConfig class];
	__xamarin_class_map [12].handle = [GroundStation_HistoryPlot class];
	__xamarin_class_map [13].handle = [GroundStation_ValuePlot class];
	__xamarin_class_map [14].handle = [GroundStation_UIStatusDisplay class];
	...
	__xamarin_class_map [34].handle = objc_getClass ("UITextView");
	...
	__xamarin_class_map [41].handle = objc_getClass ("UISlider");
	__xamarin_class_map [42].handle = objc_getClass ("UISwitch");
	...
	__xamarin_class_map [56].handle = objc_getClass ("GLKit_GLKView__GLKViewDelegate");
	__xamarin_class_map [57].handle = objc_getClass ("GLKView");
	...
	__xamarin_class_map [62].handle = [SKCanvasView class];
	__xamarin_class_map [63].handle = [ChartView class];
	__xamarin_class_map [64].handle = [SkiaSharp_Views_iOS_SKGLLayer class];
	__xamarin_class_map [65].handle = [SKGLView class];
	__xamarin_class_map [66].handle = [SkiaSharp_Views_iOS_SKCanvasLayer class];
